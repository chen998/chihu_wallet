...
public class UmsMemberReceiveAddressController {
    ...
    @ResponseBody
    public CommonResult delete(@PathVariable Long id, @PathVariable String userId) {
        int count = memberReceiveAddressService.delete(id, userId);
        if (count > 0) {
            return CommonResult.success(count);
        }
        return CommonResult.failed();
    ...
    @ResponseBody
    public CommonResult<List<UmsMemberReceiveAddress>> list(String userId) {
        List<UmsMemberReceiveAddress> addressList = memberReceiveAddressService.list(userId);
