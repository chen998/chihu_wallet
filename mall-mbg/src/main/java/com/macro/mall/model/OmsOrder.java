...
public class OmsOrder implements Serializable {
    ...
    private List<OmsOrderItem> productList = new ArrayList<OmsOrderItem>();


    public List<OmsOrderItem> getProductList() {
        return productList;
    }

    public void setProductList(List<OmsOrderItem> productList) {
